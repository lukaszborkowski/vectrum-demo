...
export const Sidebar = () => {
  ...
  return (
    <div className="fixed flex flex-col items-center bottom-[50px] left-5 z-10 sm:left-[50px] ">
      ...
      <div ref={iconsRef}>
        {icons.map((link, index) => (
          <div
            className="my-0.75 cursor-pointer transition-transform duration-100 hover:scale-125"
            key={index}
          >
